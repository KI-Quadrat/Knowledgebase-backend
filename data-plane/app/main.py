...
app = FastAPI(
    ...
    description=(
        ...
        "- Requires: `JINA_API_KEY` (default scraper), `CRAWL4AI_URL` + `CRAWL4AI_API_TOKEN` (Crawl4AI `/md` fallback), "
        "`LLAMA_CLOUD_API_KEY` (optional), `OPENAI_API_KEY` (for classification + OpenAI embedding), "
