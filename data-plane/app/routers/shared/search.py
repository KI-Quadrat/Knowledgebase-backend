...
@router.post(
    ...
    description=(
        ...
        "Requires the collection to have been ingested with `search_mode: hybrid`.\n\n"
        ...
        "- `bge_m3` → `dense_bge_m3` (1024-dim, BGE-M3 via the configured TEI endpoint)\n\n"
        ...
        "2. (Hybrid only) Encode the query sparse via the configured TEI sparse endpoint\n"
